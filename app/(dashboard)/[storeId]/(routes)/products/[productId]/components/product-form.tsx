...
const ProductForm: React.FC<ProductFormProps> = ({ initialData, categories, sizes, colors }) => {
  ...
  const toastMessage = initialData ? "Product updated." : " product";
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
          ...
          <div className="md:grid md:grid-cols-3 gap-8">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="number" disabled={loading} placeholder="Product Price (INR)" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div /> {/** To make only two items: name and price be displayed in one row. (As <div/> will be the third item of this row of grid.) */}
            ...
            />
              ...
              <div/> {/** To make only two items: isFeatured and isArchived be displayed in one row. (As <div/> will be the third item of this row of grid.) */}
